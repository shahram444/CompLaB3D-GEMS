...
| `workedExample.py` | carries two voxels through every equation of the path, in both the single-output and the multi-output form, and prints the trace beside the linear program's own answer |
