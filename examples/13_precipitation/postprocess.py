...
def main():
    ...
    print('cannot verify that from totals alone. Name a CLOSED sum in <diagnostics> instead:')
    print('')
    print('    <conserve>Fe2+FeS</conserve>')
    print('    <conserve1>HS+FeS</conserve1>')
    print('')
    print('and let the solver check it every interval. That is the check this case really wants.')
    print('')
