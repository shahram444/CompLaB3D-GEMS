...
#
# 03_abiotic_kinetics
# A second-order chemical reaction, A + B -> C, with no organisms.
#
...
#SBATCH --job-name=complab_03_abiotic_kinetics
# the lab partition
...
#SBATCH --mem=16gb
# wall clock ceiling; 1500 steps on this grid finishes well inside it
