#!/bin/bash
#
# 22_cybernetic_switching
# A carbon-weighted blend of per-substrate metabolic solutions.
#
...
#SBATCH --job-name=complab_22_cybernetic_switching
# the lab partition
...
module load GLPK/5.0-GCCcore-11.3.0        # the linear-program solver this case calls at every voxel
