#!/usr/bin/env python3
"""
07_biotic_lattice_boltzmann  --  PRE-PROCESSING

Builds the pore space this case runs on: the same slot again. [v1.3] This population is an
attached biofilm, meaning it is seeded on its own material number and stays fixed there;
earlier text here called it planktonic and advected, which the shipped CompLaB.xml
contradicts. The patch is where it starts, and it spreads from there by the lattice
Boltzmann biomass solver.
