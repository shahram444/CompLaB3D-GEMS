#!/usr/bin/env python3
"""
17_symbolic_law  --  PRE-PROCESSING

Builds the pore space this case runs on: the same slot and patch as 05, so the symbolic law can be held against compiled kinetics.
