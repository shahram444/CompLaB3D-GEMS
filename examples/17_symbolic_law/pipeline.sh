#!/usr/bin/env bash
#
# 17_symbolic_law  --  THE WHOLE PIPELINE
#
# The rate law read from a text file at start-up.
#
...
#     offline.sh       search for your own rate law (OPTIONAL)
...
# ---------------------------------------------------------------------------
echo
echo "== offline: search for your own rate law (OPTIONAL)"
./offline.sh
