#!/usr/bin/env bash
#
# 18_graph_network  --  THE WHOLE PIPELINE
#
# The whole coupled rate vector from one evaluation.
#
...
#     offline.sh       train your own graph network (OPTIONAL)
...
# ---------------------------------------------------------------------------
echo
echo "== offline: train your own graph network (OPTIONAL)"
./offline.sh
