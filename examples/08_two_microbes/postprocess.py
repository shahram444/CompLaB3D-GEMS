#!/usr/bin/env python3
"""
08_two_microbes  --  POST-PROCESSING

Two populations competing for one substrate from opposite walls.
...
def main():
    ...
    print("-" * 78)
    print('The question is which population wins, and why. Compare the two biomass totals over time,')
    print('then look at the donor MINIMUM: if it reaches zero between the two patches, they are')
    print('competing for a substrate that never gets to the far one, and the geometry decided the')
    print('outcome rather than the physiology.')
