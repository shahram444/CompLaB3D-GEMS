...
#
# 14_dissolution
# A mineral dissolving and opening the pore space as it runs.
#
...
#SBATCH --job-name=complab_14_dissolution
# the lab partition
...
#SBATCH --mem=16gb
# wall clock ceiling; 2000 steps on this grid finishes well inside it
