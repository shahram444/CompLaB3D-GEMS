...
#
# 04_equilibrium
# Carbonate speciation solved to equilibrium in every voxel.
#
...
#SBATCH --job-name=complab_04_equilibrium
# the lab partition
...
#SBATCH --mem=16gb
# wall clock ceiling; 600 steps on this grid finishes well inside it
