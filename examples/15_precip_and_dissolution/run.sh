#!/bin/bash
#
# 15_precip_and_dissolution
# Precipitation and dissolution together in one domain.
#
...
#SBATCH --job-name=complab_15_precip_and_dissolution
# the lab partition
...
#SBATCH --mem=16gb
# wall clock ceiling; 3000 steps on this grid finishes well inside it
