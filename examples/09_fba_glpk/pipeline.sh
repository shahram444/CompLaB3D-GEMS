#!/usr/bin/env bash
#
# 09_fba_glpk  --  THE WHOLE PIPELINE
#
# Growth predicted by a genome-scale linear program, through GLPK.
#
...
#     offline.sh       export the metabolic model for the GLPK path
...
# ---------------------------------------------------------------------------
echo
echo "== offline: export the metabolic model for the GLPK path"
./offline.sh
