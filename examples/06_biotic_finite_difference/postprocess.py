#!/usr/bin/env python3
"""
06_biotic_finite_difference  --  POST-PROCESSING

The same case as 05, with biomass spread by finite-difference diffusion.
...
def main():
    ...
    print("=" * 78)
    print("06_biotic_finite_difference")
    print("=" * 78)
    ...
    print("-" * 78)
    print('Run 05 and 06 on the same geometry and compare. The biomass TOTALS should be close and')
    print('the spatial PATTERN different: finite difference gives a smoother colony edge than the')
    print('automaton. That difference is the whole content of the solver choice.')
    print('')
    print('Standing caveat: the FD path is not exercised by any other shipped case. Verify it on a small')
    print('run before relying on it.')
