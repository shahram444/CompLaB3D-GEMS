#!/usr/bin/env python3
"""
06_biotic_finite_difference  --  PRE-PROCESSING

Builds the pore space this case runs on: the same slot and the same patch as 05, so the two solvers are comparable.
