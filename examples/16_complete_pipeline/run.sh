#!/bin/bash
#
# 16_complete_pipeline
# The whole chain end to end, training through post-processing.
#
...
#SBATCH --job-name=complab_16_complete_pipeline
# the lab partition
...
#SBATCH --mem=32gb
# wall clock ceiling; 400 steps on this grid finishes well inside it
