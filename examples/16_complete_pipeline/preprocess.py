#!/usr/bin/env python3
"""
16_complete_pipeline  --  PRE-PROCESSING

Builds the pore space this case runs on: a slot with one biofilm patch, for the case that exercises everything at once.
